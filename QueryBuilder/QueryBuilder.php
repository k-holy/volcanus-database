...
use Volcanus\Database\QueryBuilder\Facade;
...
class QueryBuilder
{
	 ...
	 * @return Volcanus\Database\QueryBuilder\Facade
	 */
	 ...
	 *
	 * @param Volcanus\Database\Driver\DriverInterface
	 * @return Volcanus\Database\QueryBuilder\QueryBuilderInterface
	 */
	public static function factory(DriverInterface $driver)
	{
		...
		$namespace = sprintf('\\Volcanus\\Database\\QueryBuilder\\Adapter\\%s', $driverName);
